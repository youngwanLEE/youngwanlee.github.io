...
* ## MA-EgoQA: Question Answering over Egocentric Videos from Multiple Embodied Agents<br>
   <span class="co">Kangsan Kim, Yanlai Yang, Suji Kim, Woongyeong Yeo,</span> **Youngwan Lee**, <span class="co">Mengye Ren, Sung Ju Hwang</span> <br>
   <span style="color:darkred">**Arxiv**</span> 2026 <br>
   [[project page]](https://ma-egoqa.github.io/) / [[paper]](https://arxiv.org/abs/2603.09827) / [[Dataset]](https://huggingface.co/datasets/KangsanKim71/MA-EgoQA) / [[code]](https://github.com/KangsanKim07/MA-EgoQA) <br>
 ...
 * ## VideoICL: Confidence-based Iterative In-context Learning for Out-of-Distribution Video Understanding <br>
    <span class="co">Kangsan Kim, Geon Park,</span> **Youngwan Lee**, <span class="co">Woongyeong Yeo, Sung Ju Hwang</span> <br>
...
* ## Dynamic and Super-Personalized Media Ecosystem Driven by Generative AI: Unpredictable Plays Never Repeating the Same <br>
    <span class="co">Sungjun Ahn, Hyun-Jeong Yim,</span> **Youngwan Lee**, <span class="co">Sung-Ik Park</span> <br>
...
* ## Visualizing the loss landscape of Self-supervised Vision Transformer  <br>
    **Youngwan Lee**, <span class="co">Jeffrey Ryan Willette, Jonghee Kim, Sung Ju Hwang</span> <br>
 ...
 * ## Sparse Token Transformer with Attention Back Tracking <br>
    <span class="co">Heejun Lee, Minki Kang,</span> **Youngwan Lee**, <span class="co">Sung Ju Hwang</span> <br>
    Internation Conference on Learning Representation (<span style="color:darkred">**ICLR**</span>) 2023  <br>
 ...
 * ## MPViT: Multi-Path Vision Transformer for Dense Prediction <br>
    **Youngwan Lee**, <span class="co">Jonghee Kim, Jeffrey Ryan Willette, Sung Ju Hwang</span> <br>
 ...
 * ## Localization Uncertainty Estimation for Anchor-Free Object Detection <br>
    **Youngwan Lee**, <span class="co">Joong-Won Hwang, Hyung-Il Kim, Kimin Yun, YongJin Kwon, Yuseok Bae, Sung Ju Hwang</span> <br>
 ...
 * ## Diverse Temporal Aggregation and Depthwise Spatiotemporal Factorization for Efficient Video Classification <br>
    **Youngwan Lee**, <span class="co">Hyung-Il Kim, Kimin Yun, Jinyoung Moon</span> <br>
    IEEE Access 2021  <br>
 ...
 * ## Adversarial training with stochastic weight average <br>
    <span class="co">Joong-Won Hwang,</span> **Youngwan Lee**, <span class="co">Seongchan Oh, Yuseok Bae</span><br>
 ...
 * ## Anti-Litter Surveillance based on Person Understanding via Multi-Task Learning <br>
    <span class="co">Kangmin Bae, Kimin Yun, Hyung-Il Kim,</span> **Youngwan Lee**, <span class="co">Jongyoul Park</span> <br>
 ...
 * ## CenterMask: Real-Time Anchor-Free Instance Segmentation <br>
    **Youngwan Lee**, <span class="co">Jongyoul Park</span> <br>
 ...
 * ## An Energy and GPU-Computation Efficient Backbone Network for Real-Time Object Detection <br>
    **Youngwan Lee**\*, <span class="co">Joong-Won Hwang\*, Sangrok Lee, Yuseok Bae, Jongyoul Park</span> <br>
    *:equal contribtion <br>
